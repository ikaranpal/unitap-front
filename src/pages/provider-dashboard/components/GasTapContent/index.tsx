import { ProviderDashboardButton, ProviderDashboardButtonSuccess } from 'components/basic/Button/button';
import Icon from 'components/basic/Icon/Icon';
import SearchInput from '../SearchInput/searchInput';
import { useGasTapProviderContext } from 'hooks/usePrizeOfferFormContext';
import ProvideGasFee from './component/ProvideGasFee';

const GasTapContent = () => {
	const { selectedProvideGasFee, handleSelectProvideGasFee } = useGasTapProviderContext();

	return (
		<div>
			{!selectedProvideGasFee && (
				<div>
			...
			{selectedProvideGasFee && <ProvideGasFee />}
		</div>
	);
};
