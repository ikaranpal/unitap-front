				...
				<div className="flex flex-col sm:flex-row justify-between w-full items-center py-5 px-7 text-white">
					<div className="flex items-center relative">
						<div>
							...
							<p className="text-[14px] text-gray100">Here you can provide Token for Token Tap.</p>
						</div>
						<Icon
					...
					<div className="provideToken-item-container">
						<div className="flex justify-between items-center">
							<div className="flex items-center gap-3">
								<Icon iconSrc="assets/images/provider-dashboard/btc_lightning_logo 1.svg" width="36px" height="36px" />
						...
						<div className="text-[10px] font-medium mt-2 text-white">Decentralized verification system</div>
						<div className="flex justify-between my-3">
							<div className="flex items-center gap-3">
								<div className="text-gray100 text-[10px]">on Bitcoin Lightning</div>
								<Icon iconSrc="assets/images/provider-dashboard/btc_lightning_logo 1.svg" width="14px" height="14px" />
							</div>
							<div className="flex items-center gap-3">
								<div className="text-gray80 text-[10px]">non-Repeatable</div>
								<Icon iconSrc="assets/images/provider-dashboard/reload.svg" width="14px" height="14px" />
							</div>
						</div>
