	...
	theme: {
		extend: {
			...
			backgroundImage: {
				...
				'home-header-texture': "url('/assets/images/landing/main-bg-profile.svg')",
				'what-is-unitap-header': "url('/assets/images/about/what-is-unitap-header.png')",
				'gastap-texture': "url('/assets/images/landing/gastap-texture.png')",
				'tokentap-texture': "url('/assets/images/landing/tokentap-texture.png')",
				'prizetap-texture': "url('/assets/images/landing/prizetap-texture.png')",
				'prizetap-raffle-texture': "url('/assets/images/prize-tap/raffle-win.svg')",
				'learntap-texture': "url('/assets/images/landing/learn-tap-bg.svg')",
				'launchtap-texture': "url('/assets/images/landing/launchtap-texture.png')",
				'staketap-texture': "url('/assets/images/landing/staketap-texture.png')",
